...
let provider = (adRnd < 0.60 ? "snigel" : adRnd < 0.90 ? "bsa" : adRnd < 0.95 ? "ref89" : "google");
let pageType = "";
const uic_prov_pre = (pt, provParam) => {
    if (pt == "default" || pt == "landing" || pt == "tryit" || pt == "tryitdb" || pt == "exercise" || pt == "xrcise" || pt == "video" || pt == "explainer") {
        pageType = pt;
    }
    if (provParam == "snigel" || provParam == "bsa" || provParam == "ref89" || provParam == "google") {
        provider = provParam;
    }
            ...
            if (provider == "snigel") {
                ...
                if (pageType == "default") {
                    window.snigelPubConf = {
                        "adengine": {
                            "activeLots": [{
                                    placement: "adngin-bottom_left-0",
                                    adUnit: "bottom_left"
                                },
                                {
                                    placement: "adngin-bottom_right-0",
                                    adUnit: "bottom_right"
                                },
                                {
                                    placement: "adngin-main_leaderboard-0",
                                    adUnit: "main_leaderboard"
                                },
                                {
                                    placement: "adngin-sidebar_top-0",
                                    adUnit: "sidebar_top"
                                },
                                {
                                    placement: "adngin-outstream-0",
                                    adUnit: "outstream"
                                }
                            ]
                        }
                    ...
                    window.snigelPubConf = {
                        "adengine": {
                            "activeLots": [{
                                placement: "adngin-try_it_leaderboard-0",
                                adUnit: "try_it_leaderboard"
                            }]
                        }
                    };
                    ...
                    window.snigelPubConf = {
                        "adengine": {
                            ...
                            "activeLots": [{
                                ...
                                {
                                    placement: "snhb-w3schools_video-0",
                                    adUnit: "video"
                                }
                            ]
                        }
                    ...
                    window.snigelPubConf = {
                        "adengine": {
                            ...
                            "activeLots": [{
                                placement: "adngin-explainer_video-0",
                                adUnit: "explainer_video"
                            }]
                        }
                    };
                }
            } else if (provider == "bsa" || provider == "ref89") {
                if (provider == "bsa") {
                    window.optimize = window.optimize || {
                        queue: []
                    };
                    window.optimize.queue.push(() => {
                        window.optimize.customTargeting.push(['w3_page_section', subjectFolder]);
                    });
                }
                (function() {
                    const provConsent = document.createElement('script');
                ...
                if (pageType == "default") {
                    googletag.cmd.push(function() {
                        googletag.pubads().setTargeting("page_section", subjectFolder);
                        let leaderMapping = googletag.sizeMapping().addSize([0, 0], [320, 50]).addSize([512, 0], [
                            [320, 50],
                            [468, 60]
                        ]).addSize([774, 0], [
                            [320, 50],
                        ...
                        gptAdSlots[0] = googletag.defineSlot('/16833175/MainLeaderboard', [
                            ...
                            [728, 90],
                            [970, 90]
                        ], 'div-gpt-ad-1422003450156-2').defineSizeMapping(leaderMapping).addService(googletag.pubads());
                        let skyMapping = googletag.sizeMapping().addSize([0, 0], [320, 50]).addSize([992, 0], [120, 600]).addSize([1261, 0], [
                            [120, 600],
                            [160, 600]
                        ]).addSize([1701, 0], [
                            [120, 600],
                        ...
                        gptAdSlots[1] = googletag.defineSlot('/16833175/WideSkyScraper', [
                            ...
                            [300, 600],
                            [300, 1050]
                        ], 'div-gpt-ad-1422003450156-5').defineSizeMapping(skyMapping).addService(googletag.pubads());
                        let stickyMapping = googletag.sizeMapping().addSize([0, 0], []).addSize([992, 0], [120, 600]).addSize([1261, 0], [
                            [120, 600],
                            [160, 600]
                        ]).addSize([1701, 0], [
                            [120, 600],
                        ...
                        gptAdSlots[4] = googletag.defineSlot('/16833175/StickySkyScraper', [
                            ...
                            [300, 600],
                            [300, 1050]
                        ], 'div-gpt-ad-1472547360578-0').defineSizeMapping(stickyMapping).addService(googletag.pubads());
                        let mcontMapping = googletag.sizeMapping().addSize([0, 0], [
                            [300, 250],
                            [336, 280],
                            [320, 50]
                        ]).addSize([512, 0], [
                        ...
                        gptAdSlots[5] = googletag.defineSlot('/16833175/MidContent', [
                            ...
                            [728, 90],
                            [970, 90]
                        ], 'div-gpt-ad-1493883843099-0').defineSizeMapping(mcontMapping).setCollapseEmptyDiv(true).addService(googletag.pubads());
                        let bmrMapping = googletag.sizeMapping().addSize([0, 0], [
                            [300, 250],
                            [336, 280]
                        ]).addSize([1465, 0], [
                            [300, 250],
                        ...
                        gptAdSlots[2] = googletag.defineSlot('/16833175/BottomMediumRectangle', [
                            ...
                            [336, 280],
                            [970, 250]
                        ], 'div-gpt-ad-1422003450156-0').defineSizeMapping(bmrMapping).setCollapseEmptyDiv(true).addService(googletag.pubads());
                        let rbmrMapping = googletag.sizeMapping().addSize([0, 0], []).addSize([1176, 0], [
                            [300, 250],
                            [336, 280]
                        ]).build();
                        gptAdSlots[3] = googletag.defineSlot('/16833175/RightBottomMediumRectangle', [
                            [300, 250],
                            [336, 280]
                        ], 'div-gpt-ad-1422003450156-3').defineSizeMapping(rbmrMapping).setCollapseEmptyDiv(true).addService(googletag.pubads());
                    });
                    window.snigelPubConf = {
                        "adengine": {
                            "activeLots": [],
                    ...
                    googletag.cmd.push(function() {
                        googletag.pubads().setTargeting("page_section", subjectFolder);
                        let leaderMapping = googletag.sizeMapping().addSize([0, 0], [320, 50]).addSize([468, 0], [
                            [320, 50],
                            [468, 60]
                        ]).addSize([728, 0], [
                            [320, 50],
                        ...
                        gptAdSlots[0] = googletag.defineSlot('/16833175/TryitLeaderboard', [
                            ...
                            [728, 90],
                            [970, 90]
                        ], 'div-gpt-ad-1428407818244-0').defineSizeMapping(leaderMapping).addService(googletag.pubads());
                    });
                    window.snigelPubConf = {
                        "adengine": {
                            "activeLots": [],
                    ...
                    googletag.cmd.push(function() {
                        ...
                        let stickyMapping = googletag.sizeMapping().addSize([0, 0], []).addSize([992, 0], [
                            [120, 600],
                            [160, 600]
                        ]).addSize([1820, 0], [160, 600]).addSize([1683, 0], [
                            [120, 600],
                            [160, 600],
                            [300, 250],
                            [300, 600],
    ...
    if ((!_uic_u_ok() && (pageType != "landing")) || (_uic_u_ok() && (pageType == "video" || pageType == "explainer"))) {
        (function() {
            ...
            } else if (provider == "ref89") {
                provLoader.async = true;
                provLoader.src = 'https://tags.refinery89.com/w3schoolscom.js';
            }
...
const uic_prov_sec = () => {
    if (!_uic_u_ok()) {
        if (pageType == "landing") {
                ...
                if (provider == "snigel") {
                            ...
                            if (document.getElementById("adngin-mid_content-0")) {
                                adngin.queue.push(function() {
                                    adngin.cmd.startAuction([{
                                        ...
                                        {
                                            placement: "adngin-mid_content-0",
                                            adUnit: "mid_content"
                                        }
                                    ]);
                                });
                    ...
                    if (window.optimize && window.optimize.isInitialized) {
                        ...
                        if (mainHeight > 2000) {
                            if (midAdElement) {
                                window.optimize.queue.push(() => {
                                    window.optimize.push(['bsa-zone_1715095830317-3_123456', 'bsa-zone_1715093236946-0_123456']);
                                });
                            } else {
                                window.optimize.queue.push(() => {
                                    window.optimize.push('bsa-zone_1715095830317-3_123456');
                                });
                            }
                        } else if (midAdElement) {
                            window.optimize.queue.push(() => {
                                window.optimize.push('bsa-zone_1715093236946-0_123456');
                            });
                        }
                    }
                } else if (provider == "google") {
                    ...
                    if (mainHeight > 2000) {
                        if (midAdElement) {
                            googletag.cmd.push(function() {
                                googletag.display('div-gpt-ad-1493883843099-0');
                            });
                            googletag.cmd.push(function() {
                                googletag.display('div-gpt-ad-1472547360578-0');
                            });
                        } else {
                            googletag.cmd.push(function() {
                                googletag.display('div-gpt-ad-1472547360578-0');
            ...
            if (provider == "bsa" || provider == "ref89") {
                uic_prov_consent();
            }
        }
    }
...
const uic_prov_al = () => {
    ...
    if (_uic_u_ok()) {
        if (pageType == "default" || pageType == "video") {
            ...
            if (breadcrumb) {
                if (tryTopNav.length > 0) {
                    tryTopNav[0].style.top = "40px";
                }
                if (dragBar) {
                    dragBar.style.top = "85px";
                }
                if (container) {
            ...
            if (tryitLeaderboard) {
                tryitLeaderboard.parentElement.parentElement.remove();
            }
        ...
        if (pageType == "default" || pageType == "video") {
            (function() {
                ...
                if (provider == "snigel") {
                    ...
                    provLeaderboard.class = 'r89-desktop-billboard-atf';
                } else if (provider == "google") {
                ...
                if (mainLeaderboard) {
                    ...
                    if (provider == "google") {
                        googletag.cmd.push(function() {
                            googletag.display('div-gpt-ad-1422003450156-2');
                        });
                    }
                }
            })();
            (function() {
                ...
                if (provider == "snigel") {
                    ...
                    provMidContent.class = 'r89-desktop-InContent';
                } else if (provider == "google") {
            ...
            (function() {
                ...
                if (provider == "snigel") {
                    ...
                    provWideSky.class = 'r89-desktop-hpa-atf';
                } else if (provider == "google") {
            ...
            if (provider == "snigel") {
                (function() {
                    ...
                    if (vidPos) {
                        vidPos.appendChild(provOutstream);
                    }
                })();
            }
            (function() {
                ...
                if (provider == "snigel") {
                    ...
                    provStickySky.class = 'r89-desktop-hpa-btf';
                } else if (provider == "google") {
            ...
            (function() {
                ...
                if (provider == "snigel") {
                    ...
                    provLeftBottom.class = 'r89-desktop-billboard-btf';
                    provBottomAds.appendChild(provLeftBottom);
                } else if (provider == "google") {
                ...
                if (bottom) {
                    if (provider == "snigel" || provider == "ref89") {
                    ...
                    if (provider == "google") {
                        googletag.cmd.push(function() {
                            googletag.display('div-gpt-ad-1422003450156-0');
                        });
                        googletag.cmd.push(function() {
                            googletag.display('div-gpt-ad-1422003450156-3');
                        });
                    }
                }
            })();
            ...
            (function() {
                ...
                if (tryitLeaderboard) {
                    tryitLeaderboard.appendChild(provLeaderboard);
                }
            })();
            if (pageType == "xrcise") {
                if (provider == "snigel") {
                    (function() {
                        ...
                        if (bottomPlacement) {
                            bottomPlacement.appendChild(provAdhesive);
                        }
                    })();
                }
            } else if (pageType == "tryitdb") {
                (function() {
                    ...
                    if (provider == "snigel") {
                        ...
                        provDBSky.class = 'r89-desktop-hpa-at';
                    } else if (provider == "google") {
                        provDBSky.id = 'div-gpt-ad-1472547360578-0';
                    }
                    if (sqlstickyadcontainer) {
                        sqlstickyadcontainer.appendChild(provDBSky);
                    }
                })();
            }
            if (provider == "google") {
